...
## Corpus Check
- 184 files · ~1,050,779 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2356 nodes · 5513 edges · 139 communities (129 shown, 10 thin omitted)
...
Cohesion: 0.18
Nodes (6): CatalogRow, ExerciseDatabase, ExerciseEntry, Bool, Set, UUID
...
### Community 5 - "AuraTab"
Cohesion: 0.20
Nodes (16): BodyStats, MacroTargets, Measurement, NutritionConstants, PersonalRecord, ProgressPhoto, Bool, ClosedRange (+8 more)
...
Cohesion: 0.06
Nodes (32): String, AuraProgressBar, AuraFont, Face, SectionLabelStyle, CGFloat, Content, Font (+24 more)

### Community 11 - "LogSheetsView"
Cohesion: 0.16
Nodes (10): LogSheetsView, Bool, Date, ExerciseEntry, Program, Set, String, UUID (+2 more)

### Community 12 - "String"
Cohesion: 0.07
Nodes (42): ActiveWorkoutSeed, ExerciseLoggingView, Bool, Double, Int, String, SetRowView, SetTypeMenuSheet (+34 more)

### Community 13 - "AppState"
Cohesion: 0.09
Nodes (8): AppState, Measurement, PersonalRecord, ProgressPhoto, UserPlan, WorkoutLog, CreatePlanView, Bool
...
Cohesion: 0.07
Nodes (43): AnyJSON, T, ExerciseJSON, Payload, ProgramJSON, ProgramLibrary, SeedData, Int (+35 more)
...
Cohesion: 0.21
Nodes (19): AuraChip, AuraDangerButton, AuraListRow, AuraPrimaryButton, AuraSegmentedPicker, AuraStepper, AuraTintedButton, AuraToast (+11 more)
...
Cohesion: 0.11
Nodes (17): AuraCard, LogTabView, Bool, Date, Int, String, Void, PlanHistoryTab (+9 more)

### Community 25 - "ToastCenter"
Cohesion: 0.05
Nodes (45): AuraSectionLabel, Workout, AddToPlanSheet, CreateWorkoutIcon, MyPlanSheet, addPlan, addWorkout, assign (+37 more)
...
Cohesion: 0.42
Nodes (9): CatalogMetaRow, ExerciseWarmupProtocol, GymExerciseJSON, Int, String, WarmupProtocolJSON, WarmupStep, WarmupStepJSON (+1 more)
...
Cohesion: 0.06
Nodes (32): AuthFormView, AuthGateView, AwaitingConfirmationView, ForgotPasswordSheet, Mode, login, signUp, SetNewPasswordSheet (+24 more)

### Community 32 - "SwiftUI"
Cohesion: 0.11
Nodes (8): CelebrationOverlay, CGFloat, WorkoutSummaryView, PlanBodyMap, String, BodyView, ProgressTabView, SwiftUI
...
Cohesion: 0.20
Nodes (12): WorkoutTheme, PlanData, PlanEditorExercise, PlanMusclePalette, PlanProgram, planWkIcon(), planWkStyle(), PlanWorkout (+4 more)
...
Cohesion: 0.08
Nodes (23): CalendarDayIcon, LogSheet, add, buildFromLibrary, calendar, edit, editLog, logPast (+15 more)

### Community 45 - "PlanExerciseDetail"
Cohesion: 0.10
Nodes (19): Coordinator, ExerciseVideoView, Bool, CGFloat, String, YouTubePlayerView, ImageMemoryCache, RemoteExerciseImage (+11 more)
...
### Community 69 - ".cell"
Cohesion: 0.29
Nodes (5): PlanWorkoutStyle, ProgramDetailView, Bool, Program, String
...
Cohesion: 0.06
Nodes (31): Keys, SavedExercise, SavedWorkout, Bool, CGPoint, Date, Int, String (+23 more)
...
Cohesion: 0.17
Nodes (12): DayOverride, QuickLog, QuickLogExercise, QuickLogSet, Relation, future, past, today (+4 more)
...
### Community 135 - ".jakarta"
Cohesion: 0.27
Nodes (3): DayInfo, Bool, Date
...
- **Why does `AppState` connect `AppState` to `WorkoutSettingsView`, `.programRow`, `AuraTab`, `Foundation`, `.jakarta`, `.persist`, `AppState.swift`, `WorkoutSessionState`, `EndWorkoutSheet`, `String`, `LogSheetsView`, `UnitFormatter`, `View`, `ExerciseDatabase`, `PlanDay`, `PlanWorkoutEditorView`, `.jakarta`, `ToastCenter`, `.row`, `Color`, `.importJSONArchive`, `SwiftUI`, `SupersetView`, `LogSheet`, `Table`, `PlanEditorExercise`, `ToastCenter`, `AuthService`, `.programRow`, `UUID`, `HealthKitService`, `.parse`, `.cell`, `NutritionView`, `AuraFitnessApp`, `CreateExerciseView`, `DayOverride`, `SaveEditScopeSheet`, `LogMeasurementSheet`?**
  _High betweenness centrality (0.150) - this node is a cross-community bridge._
- **Why does `WorkoutSessionState` connect `AuthService` to `SwiftUI`, `SupersetView`, `WorkoutModal`, `.jakarta`, `.persist`, `EndWorkoutSheet`, `String`, `ToastCenter`, `AppState`, `ToastCenter`, `.scheduleRestComplete`, `Color`, `ActiveWorkoutScreen`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `Workout` connect `ToastCenter` to `WorkoutEditorView`, `AuraTab`, `Table`, `.jakarta`, `.persist`, `ExerciseEntryDetailView`, `LogSheetsView`, `WeekStripView`, `String`, `PlanProgramsBody`, `ExerciseDatabase`, `AuthService`, `PlanDay`, `.jakarta`, `Codable`?**
