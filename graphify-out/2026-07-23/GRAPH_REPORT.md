...
## Corpus Check
- 185 files · ~1,079,915 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2360 nodes · 5520 edges · 137 communities (127 shown, 10 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 383 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e0dc984d`
...
- `LogTab()` --indirect_call--> `iso()`  [INFERRED]
  App onboarding/combined/log.jsx → App onboarding/app/store.jsx
- `WorkoutEditorView()` --references--> `PLAN_EXERCISES_LIB`  [EXTRACTED]
  App onboarding/plan/app.jsx → App onboarding/plan/data.jsx
...
### Community 5 - "AuraTab"
Cohesion: 0.18
Nodes (15): BodyStats, MacroTargets, Measurement, NutritionConstants, PersonalRecord, ProgressPhoto, Bool, ClosedRange (+7 more)
...
### Community 8 - ".persist"
Cohesion: 0.08
Nodes (17): programs, ProgramDatabase, SeedIDMigration, SeedPurgeMigration, Bool, Date, Double, IndexSet (+9 more)

### Community 9 - "MyPlansView"
Cohesion: 0.11
Nodes (18): Workout, AddToPlanSheet, IntBox, Mode, create, edit, ProgramEditorView, Binding (+10 more)
...
Cohesion: 0.13
Nodes (12): AuraPrimaryButton, LogSheetsView, Bool, Date, ExerciseEntry, Program, Set, String (+4 more)

### Community 12 - "String"
Cohesion: 0.33
Nodes (10): ActiveWorkoutSeed, ExerciseLibrary, Bool, Exercise, PRRecord, SetHistory, Double, TargetRecord (+2 more)

### Community 13 - "AppState"
Cohesion: 0.11
Nodes (6): AppState, Measurement, PersonalRecord, ProgressPhoto, WorkoutLog, Bool
...
Cohesion: 0.08
Nodes (29): AuthFormView, AuthGateView, AwaitingConfirmationView, ForgotPasswordSheet, Mode, login, signUp, SetNewPasswordSheet (+21 more)
...
Cohesion: 0.13
Nodes (8): LogTabView, Bool, Date, Int, String, Void, Int, Bool
...
Cohesion: 0.06
Nodes (48): AuraColorNamespace, Color, dyn(), dynA(), CGFloat, String, UIColor, AuraAxisChart (+40 more)
...
Cohesion: 0.24
Nodes (7): ExerciseLoggingView, Bool, Double, Int, String, WeekStrip, View

### Community 25 - "ToastCenter"
Cohesion: 0.09
Nodes (25): CreatePlanView, CreateWorkoutIcon, MyPlanSheet, activate, addPlan, addWorkout, assign, createWorkout (+17 more)

### Community 26 - ".row"
Cohesion: 0.13
Nodes (23): DayOverride, Kind, added, edited, logged, removed, rest, switched (+15 more)
...
Cohesion: 0.11
Nodes (16): App, AuraFitnessApp, AuthService, SessionState, awaitingEmailConfirmation, guest, loading, signedIn (+8 more)

### Community 32 - "SwiftUI"
Cohesion: 0.11
Nodes (9): WorkoutSummaryView, SaveEditScopeSheet, Void, SupersetPickSheet, Void, WorkoutLibraryView, BodyView, ProgressTabView (+1 more)
...
Cohesion: 0.43
Nodes (7): Program, Bool, Date, Int, UUID, UserPlan, Identifiable
...
Cohesion: 0.10
Nodes (20): LogSheet, add, buildFromLibrary, calendar, edit, editLog, logPast, logQuick (+12 more)

### Community 45 - "PlanExerciseDetail"
Cohesion: 0.13
Nodes (12): DayInfo, Int, DayState, done, emptyToday, future, missed, rest (+4 more)

### Community 46 - "PlanProgramsBody"
Cohesion: 0.23
Nodes (11): IdString, PlanExercisesBody, PlanProgramsBody, PlanWorkoutsBody, ProgFilter, ExerciseEntry, Int, Set (+3 more)
...
Cohesion: 0.17
Nodes (18): AnyView, PlanCatalogGrid, PlanEmptyState, PlanFilterChip, PlanIconButton, PlanLibraryCard, PlanNavbar, PlanRow (+10 more)
...
Cohesion: 0.08
Nodes (27): AuthConfig, Bool, String, URL, ImageMemoryCache, RemoteExerciseImage, CGSize, Data (+19 more)

### Community 108 - "Relation"
Cohesion: 0.50
Nodes (4): Relation, future, past, today

### Community 109 - "AuraProgressBar"
Cohesion: 0.50
...
## Knowledge Gaps
- **420 isolated node(s):** `TODAY`, `DOW`, `MONTHS`, `EXERCISES`, `WORKOUTS` (+415 more)
...
- **Why does `AppState` connect `AppState` to `Exercise`, `.secondary`, `AuraTab`, `Foundation`, `UnitFormatter`, `.persist`, `AppState.swift`, `WorkoutSessionState`, `EndWorkoutSheet`, `LogSheetsView`, `MyPlansView`, `View`, `ExerciseDatabase`, `ProfileSheet`, `PlanDay`, `ProgramEditorView`, `AuraComponents.swift`, `.jakarta`, `ToastCenter`, `.row`, `Codable`, `Color`, `.importJSONArchive`, `SwiftUI`, `SupersetView`, `QuickLogExercise`, `LogSheet`, `Table`, `ToastCenter`, `PlanExerciseDetail`, `String`, `AuthService`, `UUID`, `HealthKitService`, `PersistenceRoundTripTests`, `Kind`, `.cell`, `NutritionView`, `AuraFitnessApp`, `Color`, `CaseIterable`, `AuraProgressBar`, `SaveEditScopeSheet`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `WorkoutSessionState` connect `AuthService` to `SwiftUI`, `SupersetView`, `CelebrationOverlay`, `WorkoutModal`, `PlanSheet`, `.persist`, `MyPlansView`, `EndWorkoutSheet`, `ToastCenter`, `String`, `Kind`, `AppState`, `PlanExerciseDetail`, `.jakarta`, `Codable`, `.scheduleRestComplete`, `Color`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `Workout` connect `MyPlansView` to `Exercise`, `WorkoutEditorView`, `.persist`, `WorkoutSessionState`, `LogSheetsView`, `String`, `PlanDay`, `ProgramEditorView`, `ToastCenter`, `.row`, `Codable`, `SwiftUI`, `LogSheet`, `AuraSheetModifier`, `Table`, `PlanExerciseDetail`, `PlanProgramsBody`, `AuthService`, `UUID`?**
